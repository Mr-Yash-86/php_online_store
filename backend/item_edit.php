...
$item=$stmt->fetch(PDO::FETCH_ASSOC);
 ?>
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800 text-center">Item Edit</h1>
          <div class="row">
            <div class="offset-md-2 col-md-8">
              <form method="POST" action="updateItem.php" enctype="multipart/form-data" >
                ...
                <div class="form-group">
                  ...
                  <img src="<?=$item['photo']?>" width="200" height="150" class="mt-3">
                ...
                <div class="form-group">
                  ...
                  <!-- <input type="text" name="item_sub" class="form-control"> -->
                </div>
                <div class="form-group">
